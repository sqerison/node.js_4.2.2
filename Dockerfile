...
ENV VERSION=v4.2.2 NPM_VERSION=3 CONFIG_FLAGS="--fully-static --without-npm" DEL_PKGS="curl make gcc g++ binutils-gold python linux-headers paxctl libgcc libstdc++"
